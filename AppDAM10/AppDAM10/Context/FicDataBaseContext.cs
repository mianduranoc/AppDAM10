...
namespace AppDAM10.Context
{
    class FicDataBaseContext:DbContext
    {
        ...
        public DbSet<zt_inventarios_acumulados> zt_inventarios_acumulados { set; get; }
        ...
        public async void FicMetCreateDataBase()
        {
            try
            {
            ...
            {
                await new MainPage().DisplayAlert("Alerta", e.Message.ToString(), "OK");
            }
        }
        protected async override void OnModelCreating(ModelBuilder modelBuilder)
        {
            try
            {
                ...
                modelBuilder.Entity<zt_inventarios_acumulados>()
                    .HasKey(a => new { a.IdInventario, a.IdSKU, a.IdUnidadMedida });
                ...
                modelBuilder.Entity<zt_cat_productos_medidas>()
                    .HasKey(c => new { c.IdSKU, c.IdUMedidaBase });
                ...
                modelBuilder.Entity<zt_inventarios_conteos>()
                    .HasKey(c => new { c.IdInventario, c.IdSKU, c.IdUnidadMedida, c.IdAlmacen, c.IdUbicacion, c.NumConteo });
